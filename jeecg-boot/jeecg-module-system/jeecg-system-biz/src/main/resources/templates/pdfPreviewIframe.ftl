...
function openScanFile(title,token,bizNo,archivesNo){
 	 //var pdfUrl ="http://47.98.113.99:8080/jeecg-boot/generic/web/viewer.html?file="+encodeURIComponent("http://47.98.113.99:8080/jeecg-boot/test/jeecgDemo/getPdfUrl?title="+encodeURI(title));
